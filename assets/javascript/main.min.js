$(document).ready(function () {
  var projectsArray = [{
    ...
    thumbnail: "assets/images/SP.webp",
    modalID: "southPark",
    modalLabel: "unit3b",
    modalTitle: "Word Guess Game",
    modalImg: "assets/images/SP-modal.webp",
    ...
    thumbnail: "assets/images/Trivia1.webp",
    modalID: "triviaOne",
    modalLabel: "unit5a",
    modalTitle: "General Health Trivia",
    modalImg: "assets/images/Trivia1-modal.webp",
    ...
    thumbnail: "assets/images/Trivia2 SV.webp",
    modalID: "triviaTwo",
    modalLabel: "unit5b",
    modalTitle: "Silicon Valley Trivia",
    modalImg: "assets/images/Trivia2-modal.webp",
    ...
    thumbnail: "assets/images/StarWars.webp",
    modalID: "starWars",
    modalLabel: "unit4b",
    modalTitle: "The Last Jedi",
    modalImg: "assets/images/StarWars-modal.webp",
    ...
    thumbnail: "assets/images/CrystalCollector.webp",
    ...
    thumbnail: "assets/images/GifTastic.webp",
    modalID: "gifTastic",
    modalLabel: "unit6",
    ...
    projectName: "Psychic",
    thumbnail: "assets/images/Psychic Game.webp",
    modalID: "psychicGame",
    modalLabel: "unit3a",
    ...
    thumbnail: "assets/images/Train Clock.webp",
    ...
    thumbnail: "assets/images/anki.webp",
    modalID: "liriBot",
    modalLabel: "unit9",
  ...
  function displayGallery() {
    $.each(projectsArray, function (index) {
      $(this).delay(index * 1000).fadeIn(1000);
      var divCard = $("<div>").addClass("card bg-light").attr("style", "display:none");
      ...
      var modalHeader = $("<div>").addClass("modal-header").append([$("<h5>").addClass("modal-title").attr("id", this.modalLabel).text(this.modalTitle), $("<button>").addClass("close").attr({
        "data-dismiss": "modal",
        "aria-label": "Close"
      }).append("<i class='fas fa-times fa-xs'></i>")]);
      var modalBody = $("<div>").addClass("modal-body").append([$("<div>").addClass("container-fluid")]);
      var projectImg = $("<img>").addClass("img-fluid").attr("src", this.modalImg);
      var projectDescription = $("<em>").text(this.description);
      var modalRow = $("<div>").addClass("row").append([$("<div>").addClass("col-md-7").append(projectImg), $("<div>").addClass("col-md-5").append(projectDescription)]);
      ...
      //fade in to display portfolio gallery
      $("#portfolioGallery").fadeIn(2000, function(){
        divCard.fadeIn(2000);
      })
    })
  }
